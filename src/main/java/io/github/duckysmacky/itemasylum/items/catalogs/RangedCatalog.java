...
public final class RangedCatalog implements ItemCatalog {
    public final CatalogItem[] ITEMS = new CatalogItem[]{
        ...
        new CatalogItem("Digger Grenade", "HBM_GRENADE_BURST", 3, Rarity.EPIC, "No sir I wanted to say DIGGER, not NIG-"),
        ...
        new CatalogItem("Null Grenade", "HBM_GRENADE_IF_NULL", 8, Rarity.LEGENDARY),

        new CatalogItem("Euthanasia", "HBM_GUN_EUTHANASIA", Rarity.LEGENDARY,
            "HBM_GUN_EUTHANASIA", 16),
        ...
        new CatalogItem("THE SUN", "HBM_GRENADE_FLARE", 16, Rarity.LEGENDARY),

        new CatalogItem("Player Deleter", "HBM_GUN_B93", Rarity.MYTHIC),
