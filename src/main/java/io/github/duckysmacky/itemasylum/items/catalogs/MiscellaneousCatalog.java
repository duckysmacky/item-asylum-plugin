...
public final class MiscellaneousCatalog implements ItemCatalog {
    public final CatalogItem[] ITEMS = new CatalogItem[]{
        ...
        new CatalogItem("TNT", "TNT", 16, Rarity.COMMON,
            "FLINT_AND_STEEL", 1),
...
//        new CatalogItem("Flight Chorus", "CYCLICMAGIC_GLOWING_CHORUS", Rarity.MYTHIC),
        ...
        new CatalogItem("Oranos Juice", "HBM_BOTTLE2_KORL", Rarity.SECRET),

        new CatalogItem("Trollface Mask", "MEMEINABOTTLE_TROLL_MASK", Rarity.SECRET),

        new CatalogItem("A round of Rainbow Six Siege", "HBM_PLAN_C", Rarity.SECRET),
    };
